...
<footer class="bg-dark text-light text-center text-md-start">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-center p-3 bg-darkGray">
        ...
        <a class="text-light text-decoration-none ms-sm-0 ms-md-3" href="https://daniel-ventura.com"
            target="_blank">dan-vent</a>
        <a class="mb-0 text-uppercase text-light text-decoration-none ms-sm-0 ms-md-3" href="#">Privacy
            Policy</a>
